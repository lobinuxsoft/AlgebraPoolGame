...
public class HitWhiteBall : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ballMouseLine.SetPosition(0, whiteBall.transform.position - (direction * distanceMousePressedMouseReleased)); //Posición final de la flecha
        ballMouseLine.SetPosition(1, whiteBall.transform.position); //Posicion inicial de la flecha
